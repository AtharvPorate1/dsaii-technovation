          ...
          <div className='FormLabel'>
            <div className='event'>
              ...
              <select required className='halfInput' style={{ padding: "4px 12px" }} name="events" id="events">
                <option value="Modern Dance">Hackathon</option>
                <option value="Quize">Quize </option>
                <option value="Poetry Slam">Poetry Slam</option>
                <option value="Painting">TechNova</option>
                <option value="Short Film Making">Temporal Nexus</option>
                <option value="Essay">Spmething</option>
